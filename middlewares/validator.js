...
const validated = (req, res, next) => {
  try {
    ...
    const { error } = userValidation.validateAsync(req.body, { abortEarly: false }); //* "abortEarly : false"=> It makes the program not stop after the first error and all input data is checked first.
